...
export const SYNC_LANGAGES: LangageSyncConfig[] = [
  ...
  github('Laravel', 'laravel/laravel', { useTags: true, ltsSupport: true, ltsTagPrefix: 'v11' }),
  ...
  github('C#', 'dotnet/runtime', { useTags: true, ltsSupport: true, ltsTagPrefix: 'v8.0' }),
  github('C++', 'cplusplus/draft', { useTags: true, standardSupport: true }),
  github('Scala', 'scala/scala'),
  github('Symfony', 'symfony/symfony', { useTags: true, ltsSupport: true, ltsTagPrefix: 'v6.4' }),
  npm('Astro', 'astro'),
